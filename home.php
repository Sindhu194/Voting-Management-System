								...
								<form method="POST" id="ballotForm" action="submit_ballot.php">
									...
									while ($row = $query->fetch_assoc()) {
										...
										while ($crow = $cquery->fetch_assoc()) {
											...
											$candidate .= '
												<li>
													' . $input . '<button type="button" class="btn btn-primary btn-sm btn-curve clist platform" style="background-color: #FFFFFF ;color:black ; font-size: 12px; font-family:Times" data-platform="' . $crow['platform'] . '" data-fullname="' . $crow['firstname'] . ' ' . $crow['lastname'] . '"><i class="fa fa-search"></i> Platform</button><span class="cname clist">' . $crow['firstname'] . ' ' . $crow['lastname'] . '</span>
												</li>
											';
										}
